<?php
/*
Plugin Name: JSON API - Modified
Plugin URI: http://wordpress.org/extend/plugins/json-api/
Description: A RESTful API for WordPress, modified for katiehenry.com
Version: 1.0.7
Author: Dan Phiffer ( + Sam Galison )
...
@include_once "$dir/models/terms.php";
